...
def train_random_forest(x_train, y_train, settings: Settings) -> RandomForestClassifier:
    """Exercise 2: train a random forest (trees do not need feature scaling)."""
    model = RandomForestClassifier(random_state=settings.random_seed)
    model.fit(x_train, y_train)
    return model
